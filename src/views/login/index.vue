  ...
  <div class="login-container">
    ...
    >
      ...
      <el-form-item prop="Captcha">
        ...
        <div class="captcha">
          <img :src="'http://127.0.0.1:8090/api/auth/captcha/' + loginData.CaptchaID + '/150/50'" @click="getCaptcha" />
        </div>
      </el-form-item>
...
function getCaptcha() {
	request({
	  ...
	  method: 'get'
		...
		loginData.CaptchaID = res.data.data
		console.log(res)
	})
  // getCaptchaApi().then(({ data }) => {
		// console.log(data)
  //   // const { CaptchaBase64, CaptchaKey } = data;
  //   // loginData.value.CaptchaID = CaptchaKey;
